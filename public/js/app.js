...
function removeClass(_elementsClass, _classToRemove) {
  var arr = document.querySelectorAll(_elementsClass);
...
document.getElementById("range-controller").onchange = function () {
  pageLoading();
  var el = document.getElementById("range-controller");
  window.location.href = el.dataset.route + '/' + el.value;
};

window.addEventListener('DOMContentLoaded', function (event) {
  var cmpNav = document.getElementsByClassName('cmp-nav');
  Array.prototype.forEach.call(cmpNav, function (el) {
    el.addEventListener('click', function () {
      removeClass('.cmp-canvas', 'active-canvas');
      var cmpCanvas = document.getElementById('cmp-' + el.dataset.id);
  ...
  var loaderEv = document.getElementsByClassName('loading-ev');
